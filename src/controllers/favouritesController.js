import { insertFavourite, removeFavouriteByIdForUser } from "../services/favouritesService.js";

export async function createFavourite(req, res) {
  try {
    ...
    const favourite = await insertFavourite({ userId: authUserId, bookId });
