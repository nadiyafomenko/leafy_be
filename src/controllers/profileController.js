...
export async function updateMe(req, res) {
  try {
    ...
    const { username, avatarUrl, genres, dateOfBirth, language, region, favoriteAuthors } = req.body ?? {};
    const updateData = {};
    ...
    if(Array.isArray(favoriteAuthors)) updateData.favoriteAuthors = favoriteAuthors;
